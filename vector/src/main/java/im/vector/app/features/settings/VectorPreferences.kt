...
class VectorPreferences @Inject constructor(private val context: Context) {
    ...
    companion object {
        ...
        const val SETTINGS_ADD_PASSWORD_PREFERENCE_KEY = "SETTINGS_ADD_PASSWORD_PREFERENCE_KEY"
        const val SETTINGS_PASSWORD_PROTECTION_KEY = "SETTINGS_PASSWORD_PROTECTION_KEY"
        const val SETTINGS_LOCK_TIME_KEY = "LOCK_TIME_KEY"
